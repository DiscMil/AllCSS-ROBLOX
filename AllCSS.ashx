body {
	...
	background: #F8FCFF url(http://www.roblox.com/images/bg_gradient.jpg) repeat-x;
}
...
#HeaderContainer #Banner {
	background-image: url(http://www.roblox.com/images/WoodBanner.png);
...
#Banner #AuthenticationButton a {
	background: url("http://www.roblox.com/images/cssthemes/base/btn_blue.png") repeat-x scroll 0 0 transparent;
...
#Banner #Logo {
	...
	margin: 0;
	float: none;
	background: url("http://www.roblox.com/images/cssthemes/base/img-robloxlogo.png") no-repeat;
}
...
#MasterContainer {
	background: transparent url(http://www.roblox.com/images/bg_clouds.jpg) no-repeat scroll center top;
		width: 100%;
		overflow: auto;
}
...
.Exclamation {
	background: url(http://www.roblox.com/images/Icons/exclamation.png) no-repeat;
		height: 16px;
		width: 16px;
		float: left;
}
...
.btn-ok {
	...
	width: 102px;
	height: 50px;
	background: url(http://www.roblox.com/images/Buttons/btn-ok.png);
}
...
.catalog_nav a:visited {
	background: #b9cee5 url(http://www.roblox.com/images/tabmiddle.png) repeat-x;
		display: block;
		padding: 5px;
		margin-right: 4px;
		font-size: 14px;
...
.catalog_nav .catalog_navselected {
	display: block;
	background: #6E99C9 url(http://www.roblox.com/images/tabmiddleselected.png) repeat-x;
		padding: 5px 10px;
		margin-right: 4px;
		font-size: 14px;
		color: #FFF;
...
.Step1 {
	...
	font-size: 16px;
	font-weight: bold;
	background: url(http://www.roblox.com/images/step1.png) no-repeat 0;
		line-height: 32px;
		padding-left: 32px;
}
...
.Step2 {
	...
	font-size: 16px;
	font-weight: bold;
	background: url(http://www.roblox.com/images/step2.png) no-repeat 0;
		line-height: 32px;
		padding-left: 32px;
}
...
.Step3 {
	...
	font-size: 16px;
	font-weight: bold;
	background: url(http://www.roblox.com/images/step3.png) no-repeat 0;
		line-height: 32px;
		padding-left: 32px;
}
...
.CatalogOptions {
	float: left;
	padding: 20px;
	background: #8bc2ff url(http://www.roblox.com/images/catalog_options_back.png) repeat-x;
		border: 0;
		margin-bottom: 0;
		display: none;
		width: 176px;
...
.CatalogOptionsHelp ul li a {
	background: url(http://www.roblox.com/images/smallmetallicbutton.png) repeat-x;
...
#BuildersClubContainer div.icons {
	background-image: url(http://www.roblox.com/images/bc_page_icon_sprites.png?v=2);
	background-repeat: no-repeat;
			width: 32px;
			display: inline-block;
			text-align: center;
...
#BuildersClubContainer div.upgrades_enabled {
	background-image: url(http://www.roblox.com/images/buybc/bc_sprites_math_enabled.png);
	background-repeat: no-repeat;
			display: inline-block;
			height: 95px;
			width: 128px;
...
#BuildersClubContainer div.upgrades_disabled {
	background-image: url(http://www.roblox.com/images/buybc/bc_sprites_math_disabled.png);
	background-repeat: no-repeat;
			display: inline-block;
			height: 95px;
			width: 128px;
...
#BuildersClubContainer .bctotbcconversion {
	background-image: url(http://www.roblox.com/images/BuyBC/bc_lifetime_tbc_lifetime_discount.png);
	background-repeat: no-repeat;
			height: 95px;
			width: 128px;
}
...
#BuildersClubContainer .bctoobcconversion {
	background-image: url(http://www.roblox.com/images/BuyBC/bc_lifetime_obc_lifetime_discount.png);
	background-repeat: no-repeat;
			height: 95px;
			width: 128px;
}
...
#BuildersClubContainer .tbctoobcconversion {
	background-image: url(http://www.roblox.com/images/BuyBC/tbc_lifetime_obc_lifetime_discount.png);
	background-repeat: no-repeat;
			height: 95px;
			width: 128px;
}
...
.OBCSellSheet ul li em {
	...
	background: transparent url(http://www.roblox.com/images/obctip.png) no-repeat scroll 0 0;
		display: none;
		font-style: normal;
		height: 45px;
		left: -10px;
...
.AlertSpace .icons,
.AlertSpace .icons a {
	background-image: url(http://www.roblox.com/images/master_page_image_sprites.png?v=1202010);
	background-repeat: no-repeat;
			display: inline-block;
			vertical-align: middle;
			position: absolute;
...
.SetAddButtonAlreadyContainsItem {
	...
	font-style: italic;
	font-size: 12px;
	background: url(http://www.roblox.com/images/accept.png) no-repeat center left;
...
.friend_dropdownbutton20 {
	background: url(http://www.roblox.com/images/friendsbar/friend_dropdownBtn20h.jpg);
	float: left;
	cursor: pointer;
	height: 20px;
	width: 20px;
...
.ContestButton {
	...
	font-size: 20px;
	padding: 4px 10px;
	background: url(http://www.roblox.com/images/Contests/contestbutton.png) repeat-x;
		color: #FFF;
...
div.cannot_vote {
	height: 30px;
	width: 30px;
	background: url(http://www.roblox.com/images/Contests/not_checked_box.png);
	vertical-align: text-top;
	margin-right: 7px;
	float: left;
}
...
div.can_vote {
	height: 30px;
	width: 30px;
	background: url(http://www.roblox.com/images/Contests/checked_box.png);
	vertical-align: text-top;
	margin-right: 7px;
	float: left;
}
...
div.blinkoffheader {
	background-image: url('http://www.roblox.com/images/chat/HeaderBarRepeat1x1.jpg');
}

div.blinkonheader {
	background-image: url('http://www.roblox.com/images/chat/HeaderBarRepeat1x1_orange.jpg');
}
...
span.friend_dock_offlinestatus {
	...
	width: 16px;
	height: 16px;
	background-image: url(http://www.roblox.com/images/offline.png);
	background-repeat: no-repeat;
}
...
div.friend_dock_newmessage {
	...
	width: 16px;
	height: 16px;
	background-image: url(http://www.roblox.com/images/newmessage.png);
	background-repeat: no-repeat;
}
...
div#statusbar {
	...
	left: 0;
	height: 30px;
	background: url(http://www.roblox.com/CSS/Base/CSS/chatbarback.jpg);
...
#chat_close {
	background: url(http://www.roblox.com/CSS/Base/CSS/close.png);
	height: 10px;
	width: 10px;
	float: right;
	cursor: pointer;
...
#chat_mini {
	background: url(http://www.roblox.com/CSS/Base/CSS/mini.png);
	height: 10px;
	width: 10px;
	float: right;
	cursor: pointer;
...
.chat-unavailable {
	background: url(http://www.roblox.com/CSS/Base/CSS/unavailable.png);
	height: 15px;
	width: 15px;
	float: left;
}
...
.chat-available {
	background: url(http://www.roblox.com/CSS/Base/CSS/available.png);
	height: 15px;
	width: 15px;
	float: left;
}
...
.followme_green19h {
	background-image: url('http://www.roblox.com/images/Buttons/followme_19h.png');
	background-repeat: no-repeat;
...
.followme_gray19h {
	background-image: url('http://www.roblox.com/images/Buttons/followme_19h-gray.png');
	background-repeat: no-repeat;
			background-position: left top;
			height: 19px;
			cursor: pointer;
...
.tab_white19hselected {
	background: transparent url('http://www.roblox.com/images/friendsbar/tab_white19h_l2.gif') no-repeat left top;
		color: #444;
		display: block;
		float: left;
...
.tab_white19hselected span {
	background: transparent url('http://www.roblox.com/images/friendsbar/tab_white19h_r2.gif') no-repeat right top;
		display: block;
		height: 15px;
...
.tab_white19h_flash {
	background: transparent url('http://www.roblox.com/images/friendsbar/tab_blue19h_l.gif') no-repeat left top;
}

.tab_white19h_flash span {
	background: transparent url('http://www.roblox.com/images/friendsbar/tab_blue19h_r.gif') no-repeat right top;
		color: White;
}
...
.InGamePopup {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/containerBkg_01.png);
	_overflow: hidden;
}

.voteYes {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/button_vote.jpg);
	width: 24px;
	height: 23px;
	background-position: top left;
}
...
.overrideColumn1c .GiftCardLink {
	background: url(http://www.roblox.com/images/Buttons/btn-get_gift_card.jpg) no-repeat;
		width: 560px;
		height: 90px;
}
...
#GiftCardCrossLink {
	background: url(http://www.roblox.com/images/Gifting/img-gifting160.jpg) no-repeat;
		width: 160px;
		height: 600px;
}
...
#BCGiftCardXLink {
	background: url(http://www.roblox.com/images/Gifting/img-gifting270.jpg) no-repeat;
		background-color: White;
		margin-bottom: 10px;
}
...
@font-face {
	...
	src: url('http://www.roblox.com/CSS/Base/CSS/Fonts/Delicious-Bold.otf');
}
...
.adminStyle .login {
	...
	width: 172px;
	padding: 0 0 3px 0;
	background: url(http://www.roblox.com/CSS/Base/graphics/bg_login_bottom.png) no-repeat bottom left;
}
...
.adminStyle .login_header {
	...
	background: url(http://www.roblox.com/CSS/Base/graphics/bg_login_header.gif) repeat-x top left;
}
...
.adminStyle .nav {
	...
	float: left;
	display: block;
	background: url(http://www.roblox.com/CSS/Base/graphics/nav-bg.gif) repeat-x;
		line-height: 26px;
		overflow: hidden;
}
...
.adminStyle .nav_button_div {
	...
	float: left;
	display: block;
	background: url(http://www.roblox.com/CSS/Base/graphics/nav-div.gif) no-repeat;
}
...
.adminStyle .nav a:hover {
	text-decoration: underline;
	background: url(http://www.roblox.com/CSS/Base/graphics/nav-bg-hover.gif) repeat-x;
}
...
.adminStyle .nav a.nav_on:active {
	text-decoration: none;
	background: url(http://www.roblox.com/CSS/Base/graphics/nav-bg-on.gif) repeat-x;
}
...
.adminStyle .breadcrumb {
	...
	padding: 0 0 0 9px;
	background: url(http://www.roblox.com/CSS/Base/graphics/arrow-breadcrumb.gif) no-repeat left;
}
...
.adminStyle .panel_header_left {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-left.png) no-repeat top left;
}

.adminStyle .panel_header_left2 {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-left2.png) no-repeat top left;
}

.adminStyle .panel_header_left_white {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-left-white.gif) no-repeat top left;
}

.adminStyle .rollover_header_left {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/rollover-corner-top-left.png) no-repeat top left;
}

.adminStyle .panel_header_right {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-right.png) no-repeat top right;
}

.adminStyle .panel_header_right2 {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-right2.png) no-repeat top right;
}

.adminStyle .panel_header_right_white {
	height: 28px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-top-right-white.gif) no-repeat top right;
}

.adminStyle .rollover_header_right {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/rollover-corner-top-right.png) no-repeat top right;
}
...
.adminStyle .panel_header_content {
	...
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-header-bg.png) repeat-x;
}
...
.adminStyle .panel_header_content2 {
	...
	height: 28px;
	margin: 0 10px 0 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-header-bg2.png) repeat-x;
}
...
.adminStyle .panel_header_content_white {
	...
	height: 28px;
	margin: 0 10px 0 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-header-bg-white.gif) repeat-x;
}
...
.adminStyle .panel_footer_left {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-bottom-left.png) no-repeat left;
}

.adminStyle .panel_footer_left2 {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-bottom-left2.png) no-repeat left;
}

.adminStyle .panel_footer_right {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-bottom-right.png) no-repeat right;
}

.adminStyle .panel_footer_right2 {
	height: 10px;
	background: url(http://www.roblox.com/CSS/Base/graphics/panel-corner-bottom-right2.png) no-repeat right;
}
...
.adminStyle .online {
	padding: 0 0 0 11px;
	background: url(http://www.roblox.com/CSS/Base/graphics/online_indicator_on.gif) no-repeat;
}

.adminStyle .offline {
	padding: 0 0 0 11px;
	background: url(http://www.roblox.com/CSS/Base/graphics/online_indicator_off.gif) no-repeat;
}

.adminStyle .footer_container {
	height: 140px;
	text-align: center;
	background: #287241 url(http://www.roblox.com/CSS/Base/graphics/bg_footer.jpg) no-repeat center top;
}
...
.adminStyle .button_small_gray_left {
	...
	width: 9px;
	height: 17px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-gray-left.gif) no-repeat;
}
...
.adminStyle .button_small_gray_right {
	...
	width: 9px;
	height: 17px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-gray-right.gif) no-repeat;
}
...
.adminStyle .button_blue_left {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-blue-left.gif) no-repeat;
}
...
.adminStyle .button_blue_right {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-blue-right.gif) no-repeat;
}
...
.adminStyle .button_black_left {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-black-left.gif) no-repeat;
}
...
.adminStyle .button_black_right {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-black-right.gif) no-repeat;
}
...
.adminStyle .button_gray_left {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-light-gray-left.gif) no-repeat;
}
...
.adminStyle .button_gray_right {
	...
	width: 9px;
	height: 19px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-light-gray-right.gif) no-repeat;
}
...
.adminStyle .button_glossy_left {
	...
	width: 16px;
	height: 38px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-glossy-left.gif) no-repeat;
}
...
.adminStyle .button_glossy_right {
	...
	width: 20px;
	height: 38px;
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-glossy-right.gif) no-repeat;
}
...
.adminStyle .button_glossy_content {
	...
	background: url(http://www.roblox.com/CSS/Base/graphics/btn-glossy-middle.gif) repeat-x;
}
...
.adminStyle .fpo {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon-fpo.gif) no-repeat;
}
...
.adminStyle .item_hats {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_hats.gif) no-repeat;
}
...
.adminStyle .item_backdrops {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_backdrops.gif) no-repeat;
}
...
.adminStyle .item_buidlings {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_buildings.gif) no-repeat;
}
...
.adminStyle .item_shirts {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_shirts.gif) no-repeat;
}
...
.adminStyle .item_furniture {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_furniture.gif) no-repeat;
}
...
.adminStyle .item_all {
	...
	margin: 1px 0 0 0;
	padding: 0 0 0 20px;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon_all.gif) no-repeat;
}
...
.adminStyle .left_col_selected {
	...
	margin: 0 0 0 -12px;
	padding: 0 0 0 12px;
	background: #a0a0a0 url(http://www.roblox.com/CSS/Base/graphics/arrow-breadcrumb.gif) no-repeat left;
}
...
.adminStyle .comments_abuse {
	...
	margin: 5px 0 0 0;
	text-align: right;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon-abuse.gif) no-repeat;
}
...
.adminStyle .tab_on .tab_left {
	...
	width: 6px;
	height: 25px;
	background: url(http://www.roblox.com/CSS/Base/graphics/tab-left.gif) no-repeat;
}
...
.adminStyle .tab_on .tab_right {
	...
	width: 6px;
	height: 25px;
	background: url(http://www.roblox.com/CSS/Base/graphics/tab-right.gif) no-repeat;
}
...
.adminStyle .icon_public {
	...
	margin: 0 0 3px 0;
	font-weight: bold;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon-public.gif) no-repeat;
}

.adminStyle .icon_robux {
	padding: 0 0 0 20px;
	font-weight: bold;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon-robux.gif) no-repeat;
}

.adminStyle .icon_tix {
	padding: 0 0 4px 20px;
	font-weight: bold;
	background: url(http://www.roblox.com/CSS/Base/graphics/icon-tix.gif) no-repeat;
}
...
#BadgesContainer #CommunityBadges .Legend #Administrator {
	background-image: url(http://www.roblox.com/images/Badges/Administrator-75x75.png?v=2);
}

#BadgesContainer #CommunityBadges .Legend #ForumModerator {
	background-image: url(http://www.roblox.com/images/Badges/ForumModerator-75x75.png?v=2);
}

#BadgesContainer #CommunityBadges .Legend #ImageModerator {
	background-image: url(http://www.roblox.com/images/Badges/ImageModerator-75x75.png?v=2);
}

#BadgesContainer #FriendshipBadges .Legend #Friendship {
	background-image: url(http://www.roblox.com/images/Badges/Friendship-75x75.png?v=2);
}

#BadgesContainer #FriendshipBadges .Legend #Inviter {
	background-image: url(http://www.roblox.com/images/Badges/Inviter-75x75.png?v=2);
}

#BadgesContainer #CombatBadges .Legend #CombatInitiation {
	background-image: url(http://www.roblox.com/images/Badges/CombatInitiation-75x75.png?v=2);
}

#BadgesContainer #CombatBadges .Legend #Warrior {
	background-image: url(http://www.roblox.com/images/Badges/Warrior-75x75.png?v=2);
}

#BadgesContainer #CombatBadges .Legend #Bloxxer {
	background-image: url(http://www.roblox.com/images/Badges/Bloxxer-75x75.png?v=2);
}

#BadgesContainer #VisitsBadges .Legend #Homestead {
	background-image: url(http://www.roblox.com/images/Badges/Homestead-70x75.png?v=2);
}

#BadgesContainer #VisitsBadges .Legend #Bricksmith {
	background-image: url(http://www.roblox.com/images/Badges/Bricksmith-54x75.png?v=2);
}
...
.CarouselPager .arrow-down {
	height: 13px;
	width: 36px;
	background: url('http://www.roblox.com/images/Groups/btn-arrowsprite-up_down.png');
	margin: 5px 0;
	display: inline-block;
}
...
#CatalogContainer .Selected {
	background: url('http://www.roblox.com/images/gamesPage_filterArrow.png') no-repeat scroll 0 1px transparent;
}
...
.CharSelectCombined .Boy {
	...
	background-image: url(http://www.roblox.com/images/Buttons/btn-play_as_boy_AB.png);
}

.CharSelectCombined .Girl {
	margin: 15px 0 30px 0;
	background-image: url(http://www.roblox.com/images/Buttons/btn-play_as_girl_AB.png);
}
...
#CuratedGames .NavButtonSelected {
	background-repeat: none;
		...
		width: 31px;
		height: 30px;
		background-image: url(http://www.roblox.com/images/Games/CuratedGames/navButton-off.jpg);
		margin: 5px;
		cursor: pointer;
}

#CuratedGames .NavButtonSelected {
	background-image: url(http://www.roblox.com/images/Games/CuratedGames/navButton-on.jpg);
}
...
.GameContainerInner .CuratedPlayButton {
	background-image: url(http://www.roblox.com/images/Games/CuratedGames/CuratedGames-playBtn.png);
	position: absolute;
	top: 220px;
	right: 20px;
	width: 326px;
...
.LoginButton {
	background-image: url(http://www.roblox.com/images/Games/CuratedGames/btn_25px_white.png);
	color: black!important;
	border: 1px solid #666;
	height: 25px;
	padding: 5px 6px;
...
.SignupButton {
	background-image: url(http://www.roblox.com/images/Games/CuratedGames/btn_25px_red.png);
...
.DarkGradientBox {
	background: url(http://www.roblox.com/images/DarkGradientW150.png) repeat-y top left;
		width: 150px;
		color: White;
		position: relative;
...
.AllowedGearRepeater_Container div.GamesInfoIcon {
	background: url(http://www.roblox.com/images/CategoryIcons/CategorySprite.png);
}

.AssetGenreRepeater_Container div.GamesInfoIcon {
	background: url(http://www.roblox.com/images/GenreIcons/GenreIconsSprite.png);
	height: 14px;
}
...
.GameFilter .SelectedSort {
	background: url(http://www.roblox.com/images/gamesPage_filterArrow.png) no-repeat 0 1px;
		cursor: pointer;
		padding-left: 20px;
		font-weight: normal;
}
...
.SearchIconButton {
	background: url(http://www.roblox.com/images/searchIcon.png) no-repeat;
		cursor: pointer;
		width: 16px;
		height: 16px;
		position: absolute;
...
.PersonalServerOverlay_Small {
	...
	width: 34px;
	height: 18px;
	background-image: url('http://www.roblox.com/images/icons/overlay_personal_small.png');
	background-repeat: no-repeat;
}
...
.PersonalServerOverlay_Big {
	...
	height: 38px;
	background-repeat: no-repeat;
			background-image: url('http://www.roblox.com/images/icons/overlay_personal_big.png');
}
...
.pagerbtns {
	background: url('http://www.roblox.com/images/Groups/blue_arrow_btns_12x12_sprite.png') no-repeat;
		position: relative;
		top: 4px;
}
...
#right-column .StandardBox {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/standardBox_01_bkg.png) top repeat-x white;
		color: #000;
}
...
.GroupListItemContainer.selected {
	background: url('http://www.roblox.com/images/gamesPage_filterArrow.png') 4px center no-repeat;
}
...
#CreateGroupBtn {
	background: url('http://www.roblox.com/images/Sets/sets_btn_create.png');
	height: 50px;
	width: 150px;
	position: relative;
	left: 8px;
...
.JoinGroupDiv {
	height: 50px;
	width: 150px;
	background: url('http://www.roblox.com/images/Groups/groups_btn_join.png');
	display: inline-block;
	margin-top: 10px;
}
.AlreadyRequestedInvite {
	height: 50px;
	width: 150px;
	background: url('http://www.roblox.com/images/Groups/groups_btn_joinpending.png');
	display: inline-block;
	margin-top: 10px;
}
.JoinGroupDiv:hover {
...
.StatusView .top {
	background: url('http://www.roblox.com/images/Groups/bg-speech_top.png') no-repeat;
		padding: 5px;
		width: 317px;
}
.StatusView .bottom {
	background: url('http://www.roblox.com/images/Groups/bg-speech_bottom.png') no-repeat;
		padding: 5px;
		padding-right: 0;
}
...
#GroupRoleSetsMembersPane .loading {
	...
	height: 69px;
	width: 100%;
	background: url('http://www.roblox.com/images/spinners/spinner16x16.gif') no-repeat center;
		*float: left;
}
...
.GroupWallPane .loading .content {
	...
	height: 100%;
	width: 100%;
	background: url('http://www.roblox.com/images/spinners/spinner100x100.gif') no-repeat center;
		z-index: 1;
}
...
#Help .descriptionPanels {
	...
	background-image: url('http://www.roblox.com/images/Speech Bubble 225.gif');
	width: 225px;
	height: 235px;
	background-repeat: no-repeat;
			margin-top: 40px;
...
#Help .forumLinks {
	...
	opacity: .93;
	background-color: #eee;
	background-image: url('http://www.roblox.com/images/help_gradient.png');
...
.MiniHeaderBG {
	...
	width: 100%;
	height: 173px;
	background: url(http://www.roblox.com/images/MiniclipHeader_BG.PNG) white bottom repeat-x;
}
#MiniWrapper {
	width: 960px;
	overflow: hidden;
...
#InboxContainer .InboxHeader {
	background: url(http://www.roblox.com/images/topNav_black.png);
	border: none;
	color: #fff;
...
.AddRemoveFavorite {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/favoriteStar_20h.png) no-repeat 0 -20px;
		margin: 0;
		display: inline-block;
		position: relative;
		top: 3px;
...
.MultiplayerVisitDisabled {
	background: url(http://www.roblox.com/images/Play.png);
	width: 250px;
	height: 48px;
}
.MultiplayerVisitDisabled {
...
.SoloVisit {
	background: url(http://www.roblox.com/images/PlaySolo.png);
	width: 143px;
	height: 48px;
}
.SoloVisitText {
...
.BuildSolo {
	background: url(http://www.roblox.com/images/BuildSolo2.png);
	width: 143px;
	height: 48px;
	position: relative;
	top: -3px;
...
.EditButton {
	background: url(http://www.roblox.com/images/EditMode2.png);
	width: 143px;
	height: 48px;
	position: relative;
	right: -237px;
...
.iPublic {
	background: url(http://www.roblox.com/images/public.png);
}
.iLocked {
	background: url(http://www.roblox.com/images/locked.png);
}
.iUnlocked {
	background: url(http://www.roblox.com/images/unlocked.png);
}
.SharedIcon {
	background: url(http://www.roblox.com/images/Shared.png);
}
.CopyLockedIcon {
	background: url(http://www.roblox.com/images/CopyLocked.png);
}
.AllGearIcon {
	background: url(http://www.roblox.com/images/Suitcase16x16.png);
}
.GenreGearIcon {
	background: url(http://www.roblox.com/images/GenreSuitcase16x16.png);
}
.NoGearIcon {
	background: url(http://www.roblox.com/images/NoSuitcase16x16.png);
}
#BadgeStatsHeader {
	color: #666;
...
.GetAFreeAccount {
	width: 316px;
	height: 56px;
	background: url(http://www.roblox.com/images/Buttons/getAFreeAccount.png);
}
.PlayAsGuest:hover {
	background-position: 0 56px;
}
.PlayAsGuest {
	width: 316px;
	height: 56px;
	background: url(http://www.roblox.com/images/Buttons/playAsGuest.png);
}
...
.closeBtnCircle_35h {
	width: 35px;
	height: 35px;
	background: url(http://www.roblox.com/images/Buttons/closeBtnCircle_35h.png);
}
.fblike {
	display: inline-block;
	float: left;
...
.btn-buynow {
	...
	width: 117px;
	height: 40px;
	background: url(http://www.roblox.com/images/Buttons/btn-buynow.png);
}
.btn-buynow:hover {
	background-position: 0 50px;
}
.btn-continueshopping {
	...
	width: 213px;
	height: 40px;
	background: url(http://www.roblox.com/images/Buttons/btn-continue_shopping.png);
}
...
.RegisterBlueButton {
	background-image: url("http://www.roblox.com/images/Buttons/Register-blue.png");
	height: 20px;
	width: 92px;
}
...
.SignupRedButton {
	background-image: url("http://www.roblox.com/images/Buttons/btn-signup.png");
	height: 50px;
	width: 111px;
}
...
.GenreInfo .GamesInfoIcon {
	display: inline-block;
	background-image: url(http://www.roblox.com/images/GenreIcons/GenreIconsSprite.png);
	width: 16px;
	height: 16px;
}
#header {
...
#loginButton span {
	...
	background: url(http://www.roblox.com/images/LandingGames/loginArrow.png) no-repeat 40px 7px;
}
...
#loginBox #loginSubmit {
	width: auto;
	float: right;
	background: url(http://www.roblox.com/images/LandingGames/login_btn.png) repeat-x;
		color: #fff;
		padding: 3px 10px 3px 10px;
...
#videoContainer {
	width: 950px;
	height: 371px;
	background: url(http://www.roblox.com/images/LandingGames/video_bg.png) no-repeat;
...
a.crossroads:visited {
	...
	display: block;
	margin-right: 10px;
	background: url(http://www.roblox.com/images/LandingGames/crossroads.gif) bottom no-repeat;
		cursor: pointer;
		float: left;
}
a.crossroads:hover {
...
a.swordfight:visited {
	...
	display: block;
	margin-right: 10px;
	background: url(http://www.roblox.com/images/LandingGames/swordfight.gif) bottom no-repeat;
		cursor: pointer;
		float: left;
}
a.swordfight:hover {
...
a.seemoregames:visited {
	...
	height: 298px;
	display: block;
	background: url(http://www.roblox.com/images/LandingGames/seeMoreGames.gif) bottom no-repeat;
		cursor: pointer;
		float: left;
}
...
.ReportAbuse .AbuseButton a:hover {
	background: url("http://www.roblox.com/images/cssspecific/rbx2/abuse.png") no-repeat scroll 0 2px transparent;
		color: #F00;
}
.ReportAbuse img {
	display: none;
...
.partyWindow .title strong {
	...
	background: url("http://www.roblox.com/images/chat/tab_blue21h_r.png") no-repeat right top;
		color: #fff;
		width: 227px;
		font-weight: bold;
}
...
.btn_green21h {
	float: left;
	background: url("http://www.roblox.com/images/chat/btn_green21h_l.png") no-repeat left top;
		padding: 0 0 0 2px;
}
.btn_green21h a {
	display: block;
	padding: 2px 14px 4px 10px;
	background: url("http://www.roblox.com/images/chat/btn_green21h_r.png") no-repeat right top;
		color: White;
		font-family: verdana;
		font-weight: bold;
		text-decoration: none;
...
.btn_green21h:hover {
	background: url("http://www.roblox.com/images/chat/btn_green21h_over_l.png") no-repeat left top;
}
.btn_green21h:hover a {
	background: url("http://www.roblox.com/images/chat/btn_green21h_over_r.png") no-repeat right top;
}
.btn_red21h {
	float: left;
	background: url("http://www.roblox.com/images/chat/btn_red21h_l.png") no-repeat left top;
		padding: 0 0 0 2px;
}
.btn_red21h a {
	display: block;
	padding: 2px 14px 4px 10px;
	background: url("http://www.roblox.com/images/chat/btn_red21h_r.png") no-repeat right top;
		color: White;
		font-family: verdana;
		font-weight: bold;
		text-decoration: none;
...
.btn_red21h:hover {
	background: url("http://www.roblox.com/images/chat/btn_red21h_over_l.png") no-repeat left top;
}
.btn_red21h:hover a {
	background: url("http://www.roblox.com/images/chat/btn_red21h_over_r.png") no-repeat right top;
}
.btn_black21h {
	float: left;
	background: url("http://www.roblox.com/images/chat/btn_black21h_l.png") no-repeat left top;
		padding: 0 0 0 2px;
		color: White;
}
.btn_black21h a {
	display: block;
	padding: 2px 14px 4px 10px;
	background: url("http://www.roblox.com/images/chat/btn_black21h_r.png") no-repeat right top;
		color: #FFF;
		font-family: verdana;
		font-weight: bold;
		text-decoration: none;
...
.btn_black21h:hover {
	background: url("http://www.roblox.com/images/chat/btn_black21h_over_l.png") no-repeat left top;
}
.btn_black21h:hover a {
	background: url("http://www.roblox.com/images/chat/btn_black21h_over_r.png") no-repeat right top;
}
.main h1 {
...
.ABImageSelected {
	background: transparent url(http://www.roblox.com/images/img-check.png) no-repeat;
		position: absolute;
		height: 35px;
		width: 33px;
		right: -3px;
...
.ABPopUpHeader {
	height: 30px;
	background: transparent url(http://www.roblox.com/images/bg-gutter.png) repeat-x;
		font: 9px Arial;
		color: #404040;
		text-decoration: none;
}
...
.UnselectedAvatar {
	background: transparent url(http://www.roblox.com/images/bg-character.png) no-repeat top center;
}
.SelectedAvatar,
.UnselectedAvatar:hover {
	background: transparent url(http://www.roblox.com/images/bg-character.png) no-repeat center bottom;
}
.ABPopUpFooter {
	height: 79px;
	background: transparent url(http://www.roblox.com/images/bg-gutter.png) repeat-x;
...
.ABDownloadButton {
	background: transparent url(http://www.roblox.com/images/btn-download.png) no-repeat top center;
}
.ABPlayButton {
	background: transparent url(http://www.roblox.com/images/btn-play.png) no-repeat top center;
}
.ABPlayButton:hover,
...
.FeaturedGameButtonABTest:hover {
	background-image: url(http://www.roblox.com/images/buttons/playRoblox01.png);
	background-position: 0 0;
	background-repeat: no-repeat;
			position: absolute;
			top: 20px;
...
#SetDescriptionDiv_content {
	min-height: 25px;
	background: url('http://www.roblox.com/images/Sets/setspop_header.png') no-repeat;
		padding: 10px;
		padding-left: 25px;
}
#SetDescriptionDiv_footer {
	background: url('http://www.roblox.com/images/Sets/setspop_footer.png');
	height: 7px;
}
.content.left {
	float: left;
...
.SetList-Set.selected {
	background: url('http://www.roblox.com/images/gamesPage_filterArrow.png') no-repeat 3px center;
		font-weight: bold;
}
.SetList-Set:hover {
	background-color: #fff;
...
#CreateFind_Button.find {
	background: url('http://www.roblox.com/images/Sets/sets_btn_find.png');
}
...
.paging_next {
	height: 24px;
	width: 24px;
	background: url('http://www.roblox.com/images/Sets/blue_arrow_btns_sprite.png');
	background-position: left top;
}
.paging_previous {
...
#AssetSetItems .setitem_options {
	...
	height: 20px;
	width: 20px;
	background: url('http://www.roblox.com/images/Sets/btn-gear_sprite.png') left -1px;
}
...
.newversion_banner {
	height: 14px;
	width: 93px;
	background: url('http://www.roblox.com/images/Sets/update_available.png') top left no-repeat;
		position: absolute;
		top: 5px;
		left: 3px;
}
...
#SetsPane .loading {
	...
	right: 0;
	background-color: white;
	background: url('http://www.roblox.com/images/Spinners/spinner100x100.gif') center no-repeat #fff;
		margin: 5px;
		z-index: 5000;
		opacity: .75;
...
.ShadowedStandardBox .Header {
	background: url(http://www.roblox.com/images/HeaderGradientW800.png) repeat-y top left;
		text-align: center;
		color: White;
		height: 20px;
		line-height: 20px;
...
.Shadow {
	display: block;
	background: url(http://www.roblox.com/images/ShadowAlpha.png) no-repeat bottom right!important;
		background: #D3DEFF;
		height: 100%;
		_height: 3000px;
		width: 100%;
...
.tipsy {
	...
	background-repeat: no-repeat;
			background-image: url(http://www.roblox.com/images/cssspecific/rbx2/tipsy.gif);
}
.tipsy-inner {
...
#WhyJoin .MembershipBenefits .Benefit_MultiplePlaces {
	background-image: url(http://www.roblox.com/images/MultiplePlacesBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_RobuxAllowance {
	background-image: url(http://www.roblox.com/images/AllowanceBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_SellContent {
	background-image: url(http://www.roblox.com/images/SellBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_SuppressAds {
	background-image: url(http://www.roblox.com/images/AdSuppressionBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_ExclusiveHat {
	background-image: url(http://www.roblox.com/images/HardHatBullet.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_OwnPlace {
	background-image: url(http://www.roblox.com/images/JoinBulletHouse.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_GetTix {
	background-image: url(http://www.roblox.com/images/JoinBulletTreasure.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_BuyStuff {
	background-image: url(http://www.roblox.com/images/JoinBulletShoppingBag.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_CustomizeGuy {
	background-image: url(http://www.roblox.com/images/JoinBulletWizardHat.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Username {
	background-image: url(http://www.roblox.com/images/JoinBulletStar.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Forums {
	background-image: url(http://www.roblox.com/images/JoinBulletScript.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Stats {
	background-image: url(http://www.roblox.com/images/JoinBulletStats.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Comments {
	background-image: url(http://www.roblox.com/images/JoinBulletPencil.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Badges {
	background-image: url(http://www.roblox.com/images/JoinBulletBadges.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Friends {
	background-image: url(http://www.roblox.com/images/JoinBulletFriends.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_WeRock {
	background-image: url(http://www.roblox.com/images/JoinBulletCreative.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_OhYeahItsFree {
	background-image: url(http://www.roblox.com/images/JoinBulletHappy.png);
}
...
.BuyRobuxBtn {
	...
	width: 205px;
	height: 44px;
	background: url(http://www.roblox.com/images/buildersClubPage_buyRobux_44px.png) no-repeat;
}
.BuyRobuxBtn:hover {
...
.GiftCards #GiftForm {
	background-image: url(http://www.roblox.com/images/Gifting/bg-black-transparent.png);
	padding: 10px;
	width: 400px;
}
.GiftCards #ErrorDiv {
...
.GiftCards .CheckMark {
	background-image: url(http://www.roblox.com/images/Gifting/img-unchecked.png);
	position: absolute;
	top: 7px;
	right: 7px;
	width: 25px;
...
.GiftCards .GCProductSelected .CheckMark {
	background-image: url(http://www.roblox.com/images/Gifting/img-checked.png);
}
.GiftCards .ThemeCheckMark {
	background: url(http://www.roblox.com/images/Gifting/img-checked-small.png) no-repeat 0 -25px;
		position: absolute;
		top: 3px;
		right: 4px;
		height: 17px;
...
.GiftCards #Product0 {
	background: url("http://www.roblox.com/images/gifting/gifting_bc.jpg") center no-repeat;
}
.GiftCards #Product0:hover {
	background-color: #cbe7fd;
}
.GiftCards #Product1 {
	background: url("http://www.roblox.com/images/gifting/gifting_tbc.jpg") center no-repeat;
}
.GiftCards #Product1:hover {
	background-color: #fdcc32;
}
.GiftCards #Product2 {
	background: url("http://www.roblox.com/images/gifting/gifting_obc.jpg") center no-repeat;
}
.GiftCards #Product2:hover {
	background-color: #fdcc32;
}
.GiftCards #Product3 {
	background: url("http://www.roblox.com/images/gifting/gifting_custom.jpg") center no-repeat;
}
.GiftCards #Product3:hover {
	background-color: #96ff92;
}
.GiftCards .GCThemeClassic {
	background: url("http://www.roblox.com/images/gifting/theme-thumb-classic.png") no-repeat 0 0;
}
.GiftCards .GCThemeClassic:hover {
	background-position: 0 -77px;
}
.GiftCards .GCThemeChristmas {
	background: url("http://www.roblox.com/images/gifting/theme-thumb-christmas.png") no-repeat 0 0;
}
...
.GiftCards .GCThemeClassic .ThemePreview {
	background: url("http://www.roblox.com/images/gifting/theme-preview-classic.png") no-repeat 0 0;
}
.GiftCards .GCThemeChristmas .ThemePreview {
	background: url("http://www.roblox.com/images/gifting/theme-preview-christmas.png") no-repeat 0 0;
}
.GiftCards .Hint {
	color: Orange;
...
.OrderSummary .PurchaseAnother {
	background: url(http://www.roblox.com/images/Buttons/btn-purchase_another.png) no-repeat;
		display: inline-block;
			*display: inline;
		width: 219px;
		height: 50px;
...
.tab_white_31h_container .ajax__tab_header {
	...
	font-size: 11px;
	background: url(http://www.roblox.com/images/tab-line.gif) repeat-x bottom;
}
.tab_white_31h_container .ajax__tab_outer {
	margin: 0;
	background: url(http://www.roblox.com/images/tab-right.gif) no-repeat right;
		height: 21px;
}
.tab_white_31h_container .ajax__tab_inner {
	padding-left: 3px;
	background: url(http://www.roblox.com/images/tab-left.gif) no-repeat;
}
.tab_white_31h_container .ajax__tab_tab {
	height: 13px;
	padding: 4px;
	margin: 0;
	background: url(http://www.roblox.com/images/tab.gif) repeat-x;
}
.tab_white_31h_container .ajax__tab_hover .ajax__tab_outer {
	background: url(http://www.roblox.com/images/tab-hover-right.gif) no-repeat right;
}
.tab_white_31h_container .ajax__tab_hover .ajax__tab_inner {
	background: url(http://www.roblox.com/images/tab-hover-left.gif) no-repeat;
}
.tab_white_31h_container .ajax__tab_hover .ajax__tab_tab {
	background: url(http://www.roblox.com/images/tab-hover.gif) repeat-x;
}
.tab_white_31h_container .ajax__tab_active .ajax__tab_outer {
	background: url(http://www.roblox.com/images/tab-active-right.gif) no-repeat right;
}
.tab_white_31h_container .ajax__tab_active .ajax__tab_inner {
	background: url(http://www.roblox.com/images/tab-active-left.gif) no-repeat;
}
.tab_white_31h_container .ajax__tab_active .ajax__tab_tab {
	background: url(http://www.roblox.com/images/tab-active.gif) repeat-x;
}
...
.GreenButton {
	height: 30px;
	background: url(http://www.roblox.com/images/btn_green_30h_t1.png) no-repeat;
}
.GreenButton span {
	height: 23px;
	background: url(http://www.roblox.com/images/btn_green_30h_t2.png) no-repeat top right;
}
.RedButton {
	height: 30px;
	background: url(http://www.roblox.com/images/btn_red_30h_t1.png) no-repeat;
}
.RedButton span {
	height: 23px;
...
.RedButton2 {
	height: 40px;
	background: url(http://www.roblox.com/images/Buttons/btn_red_40h_t1.png) no-repeat;
}
.RedButton2 span {
	height: 28px;
	background: url(http://www.roblox.com/images/Buttons/btn_red_40h_t2.png) no-repeat top right;
...
.SkinnyRightArrow {
	cursor: pointer;
	background: url(http://www.roblox.com/images/arrow_skinny55h_right.png) no-repeat;
		width: 12px;
		height: 55px;
		display: inline-block;
			*display: inline;
...
.SkinnyRightArrowDisabled {
	background: url(http://www.roblox.com/images/arrow_skinny55h_right.png) no-repeat 0 -110px;
		width: 12px;
		height: 55px;
		display: inline-block;
			*display: inline;
...
.SkinnyLeftArrow {
	cursor: pointer;
	background: url(http://www.roblox.com/images/arrow_skinny55h_left.png) no-repeat;
		width: 12px;
		height: 55px;
		display: inline-block;
			*display: inline;
...
.SkinnyLeftArrowDisabled {
	background: url(http://www.roblox.com/images/arrow_skinny55h_left.png) no-repeat 0 -110px;
		width: 12px;
		height: 55px;
		display: inline-block;
			*display: inline;
...
.BlueLeftArrow {
	cursor: pointer;
	background: url(http://www.roblox.com/images/arrow_36px_left.png) no-repeat;
		width: 36px;
		height: 36px;
		display: inline-block;
			*display: inline;
...
.BlueLeftArrow:hover {
	background: url(http://www.roblox.com/images/arrow36px_leftOn.png) no-repeat;
}
.BlueRightArrow {
	cursor: pointer;
	background: url(http://www.roblox.com/images/arrow_36px_right.png) no-repeat;
		width: 36px;
		height: 36px;
		display: inline-block;
			*display: inline;
...
.BlueRightArrow:hover {
	background: url(http://www.roblox.com/images/arrow36px_rightOn.png) no-repeat;
}
.BCHat {
	background: url(http://www.roblox.com/images/Games/gamesPage_bcHelmet.png) no-repeat;
		width: 35px;
		height: 29px;
		display: inline-block;
		margin-top: 3px;
...
.notificationBoxIE {
	display: inline-block;
	color: #fff;
	background-image: url(http://www.roblox.com/images/bg-notifications.png);
	background-repeat: repeat-x;
			background-position: left top;
			min-width: 24px;
			width: auto;
...
#videoPrerollJoinBCButton {
	width: 180px;
	height: 40px;
	background-image: url(http://www.roblox.com/images/VideoPreRoll/btn-buildersclub.png);
	background-position: top;
	display: inline-block;
	vertical-align: middle;
}
...
.PlayButton {
	background-image: url('http://www.roblox.com/images/games/playBtn_off.png');
	background-repeat: no-repeat;
}
.BuildButton {
	background-image: url('http://www.roblox.com/images/games/buildBtn_off.png');
	background-repeat: no-repeat;
}
.PlayButton:hover,
.PlayButtonSelected {
	background-image: url('http://www.roblox.com/images/games/playBtn_on.png');
	background-repeat: no-repeat;
}
.BuildButton:hover,
.BuildButtonSelected {
	background-image: url('http://www.roblox.com/images/games/buildBtn_on.png');
	background-repeat: no-repeat;
}
#BCOnlyPlaces {
	width: 416px;
...
.MultiplayerVisitDisabled {
	width: 212px;
	height: 54px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/btn_play_54h.png);
}
...
.iPublic,
.iUnlocked {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_public.png);
}
.iLocked {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_public.png);
...
.CopyLockedIcon {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_locked.png);
}
.SharedIcon {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_locked.png);
	background-position: -20px;
...
.AllGearIcon {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_gear.png);
}
.GenreGearIcon {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/icon_gear.png);
	background-position: 0 -20px;
...
body {
	margin: 0;
	padding: 0;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/bkg.jpg) top center repeat-x #000444;
		font-family: Arial, Helvetica, sans-serif;
		color: black;
		font-size: 12px;
}
...
#HeaderContainerDefaultPage {
	...
	width: 900px;
	height: 225px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/head_03.jpg) repeat scroll 0 0 transparent;
		background-position: 0 0;
		background-repeat: no-repeat;
				z-index: 6;
}
...
#HeaderContainerDefaultPage #Header #Banner #AuthenticationButton #AuthenticationBannerSpanLeft {
	background: url("http://www.roblox.com/images/cssspecific/rbx2/head_bkg_t1.png") no-repeat scroll left top transparent;
		display: block;
		height: 28px;
		padding: 0 0 0 2px;
		position: relative;
...
#SmallHeaderContainer #Banner #Logo {
	...
	margin: 0;
	float: none;
	background: url("http://www.roblox.com/images/cssspecific/rbx2/img-robloxlogo.png") no-repeat;
}
...
#SmallHeaderContainer #Banner #AuthenticationButton #AuthenticationBannerSpan {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/head_bkg_t2.png) no-repeat scroll right top transparent;
}
#SmallHeaderContainer #Banner #Authentication a {
	height: 18px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/btn_blue18h.png) repeat-x;
		background-position: 0 0;
		margin: 0 5px;
...
#SmallHeaderContainer #Banner #Authentication a:hover {
	background-position: 0 -18px;
}
#SmallHeaderContainer #Banner #Alerts {
	background: Transparent;
...
#Header .SmallHeaderAlertSpaceLeft {
	background: url("http://www.roblox.com/images/cssspecific/rbx2/bg-statbar-left.png") no-repeat scroll left center transparent;
		*background: none;
		height: 21px;
		right: 2px;
		width: auto;
...
#Header .SmallHeaderAlertSpaceLeft .AlertSpace {
	float: right;
	border: none;
	background: url("http://www.roblox.com/images/cssspecific/rbx2/bg-statbar-right.png") no-repeat scroll right 0 transparent;
		height: 22px;
		position: relative;
		top: 0;
		width: auto;
...
.SmallHeaderAlertSpaceLeft .AlertSpace a {
	padding-right: 10px;
	padding-left: 18px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/head_infobox_icons.png) no-repeat 0 0;
		position: static;
}
...
#Header .Navigation {
	width: 900px;
	height: 30px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/topNav_blue.png);
	background-position: 0 0;
	text-align: center;
	line-height: 20px;
}
...
.StandardBoxHeaderGray {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_gray_33h_t1.png) no-repeat left top;
}
...
.StandardBoxHeaderGray span {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_gray_33h_t2.png) no-repeat right top;
}
.StandardTabWhite {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_white_26h_t1.png) no-repeat left top;
		padding: 0 4px;
		float: none;
		text-align: left;
}
.StandardTabWhite span {
	...
	padding: 5px 5px 0 9px;
		*padding-right: 14px;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_white_26h_t2.png) no-repeat right top;
		font-family: Arial, Helvetica, sans-serif;
		font-size: 14px;
		color: #000;
		font-weight: normal;
...
.StandardTabGrayActive {
	position: relative;
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_white_31h_t1.png) no-repeat left top;
...
.StandardTabGrayActive span {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/tab_white_31h_t2.png) no-repeat right top;
...
a.rss_icon {
	background: url(http://www.roblox.com/images/cssspecific/rbx2/topNav_rss.png) no-repeat;
}
.Column1d .StandardTabWhite,
.Column2d .StandardTabWhite {
	width: auto;
